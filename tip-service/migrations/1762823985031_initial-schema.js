...
exports.down = pgm => {
    pgm.sql(`
        DROP TRIGGER IF EXISTS update_payout_periods_updated_at ON payout_periods;
        DROP TRIGGER IF EXISTS update_daily_reports_updated_at ON daily_reports;
        DROP TRIGGER IF EXISTS update_tip_out_rules_updated_at ON tip_out_rules;

        DROP FUNCTION IF EXISTS update_updated_at_column();

        ALTER TABLE cash_outs DROP COLUMN IF EXISTS payout_period_id;

        DROP TABLE IF EXISTS payout_periods;
        DROP TABLE IF EXISTS pool_distributions;
        DROP TABLE IF EXISTS tip_pools;
        DROP TABLE IF EXISTS report_adjustments;
        DROP TABLE IF EXISTS cash_outs;
        DROP TABLE IF EXISTS daily_reports;
        DROP TABLE IF EXISTS tip_out_rules;
    `);
};